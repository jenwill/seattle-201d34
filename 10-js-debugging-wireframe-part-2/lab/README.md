...
Create a new repository for today called **chocolate-pizza**. If you're both going to write code, have one user fork the other so that you can get some practice in your Git processes. Be sure to do frequent commits, and always do your work on branches. Before starting to code, think about a strategy for approaching this project. Come up with a practical order in which to do the work:
...
### Remember, this assignment is due at 5:00 !!!
